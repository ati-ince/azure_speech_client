...
Class-based implementation with timeout support and translation storage
"""
...
class AzureSTTTranslationClient:
    def __init__(
        self,
        base_ws_uri: str = "ws://localhost:8000/stt-translation",
        username: str = "demo",
    ...
    async def run(self,
                  ...
                  hashkey: str = None):
        """
        Initialize the STT translation client with optional parameters.
        ...
        """
        Run the STT translation client with optional timeout in seconds.
        If timeout is None, runs indefinitely until interrupted.
        Returns the collected translations dictionary.
        """
        self._running = True
        try:
